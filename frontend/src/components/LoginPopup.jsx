...
const LoginPopup = ({ onLoginSuccess, onSwitchToSignup }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      } else if (err.code === 'ERR_NETWORK' || err.message?.includes('Network Error') || err.message?.includes('ERR_CONNECTION')) {
          ...
          <div className="card-body">
            ...
            >
              <span className="btn-text">
                {loading ? 'CONNECTING...' : 'INITIATE_CONNECTION'}
              </span>
            </button>
